...
function SideCard({
  ...
  return (
    <motion.div
      ...
      className="group relative h-full w-full overflow-hidden rounded-xl bg-card text-left ring-1 ring-white/10"
    >
      <Image
...
function CenterCard({
  ...
  return (
    <motion.div
      ...
      className="relative h-full w-full overflow-hidden rounded-xl bg-black shadow-2xl shadow-black/40 "
    >
      <Image
      ...
      {trailer?.videoKey && (
        <motion.div
          ...
          initial="rest"
          animate={isHovered ? "hover" : "rest"}
          className="absolute right-4 top-4 z-20 overflow-hidden"
        >
...
export function ShowcaseRow({ row }: { row: Row }) {
  ...
  return (
    <section ref={sectionRef} className="group/showcase relative py-4 md:max-2xl:py-3">
      <div className="mb-2 flex items-center gap-2 px-4 md:px-12 md:max-2xl:mb-1 md:max-2xl:px-8">
      ...
      <div className="relative mx-4 overflow-hidden md:mx-12 md:max-2xl:mx-8">
        <div className="mx-auto grid h-[260px] max-w-[1800px] grid-cols-[19fr_62fr_19fr] items-stretch gap-2 py-2 sm:h-[360px] sm:gap-3 lg:h-[min(68vh,40vw)] lg:max-h-[640px] md:max-2xl:h-[min(58vh,36vw)] md:max-2xl:gap-2 md:max-2xl:py-1">
        ...
        {titles.length > 1 && (
          <>
            <button
              ...
              className="absolute left-2 top-1/2 z-20 grid size-9 -translate-y-1/2 place-items-center rounded-full bg-black/65 text-white opacity-0 transition-opacity group-hover/showcase:opacity-100"
            >
            ...
            <button
              ...
              className="absolute right-2 top-1/2 z-20 grid size-9 -translate-y-1/2 place-items-center rounded-full bg-black/65 text-white opacity-0 transition-opacity group-hover/showcase:opacity-100"
            >
